...
@Component({
    ...
    template: `
        <app-dialog primaryTitle="Suporte" secondaryTitle="Como entrar em contato">
            <p>
                ...
                para <a href="mailto:lucasng2002@gmail.com">lucasng2002@gmail.com</a> (gerente do projeto), com isso, aguarde nossa resposta, obrigado!
            </p>
